...
class NodeHistoryEnergyView(NodeHistoryBaseView):
    ...
    def get_db_metric(self):
        ...
        return 'node_power', 'power'


class GroupTendencyEnergyView(GroupTendencyBaseView):
    permission_classes = (AsOperatorRole,)
...
class GroupHeatEnergyView(GroupHeatBaseView):
    permission_classes = (AsOperatorRole,)
